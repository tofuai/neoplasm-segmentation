...
class HarDNetMSEG(nn.Module):
    ...
    def __init__(
        ...
        self.agg1 = aggregation(32, n_classes)
    ...
    def forward(self, x):
        ...
        lateral_map_5 = F.interpolate(ra5_feat, scale_factor=8, mode='bilinear', align_corners=False)    # NOTES: Sup-1 (bs, 1, 44, 44) -> (bs, 1, 352, 352)
